...
class TestDatabase:
    ...
    def test_save_prediction_success(self):
        ...
        with patch("database.pool.SimpleConnectionPool") as mock_pool:
            ...
            prediction_id = db.save_prediction(input_data=input_data, prediction=1, probability=0.75, model_version="1.0.0")
    ...
    def test_save_prediction_error_rollback(self):
        ...
        with patch("database.pool.SimpleConnectionPool") as mock_pool:
            ...
            with pytest.raises(Exception) as exc_info:
                db.save_prediction(input_data={"age": 35}, prediction=1, probability=0.75, model_version="1.0.0")
    ...
    def test_get_predictions_success(self):
        ...
        with patch("database.pool.SimpleConnectionPool") as mock_pool:
            ...
            mock_predictions = [{"id": 1, "prediction": 0, "probability": 0.3}, {"id": 2, "prediction": 1, "probability": 0.8}]
